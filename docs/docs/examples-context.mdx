...
### Tools used for the generated data

The documentation's examples will use a mocked set of people, generated with the [@faker-js/faker](https://fakerjs.dev/). <br/>
You can see the complete array at the bottom of this page.

:::note

Some examples, for semplicity only use a small subset of the _people array_

:::

### Demo of the results

Various sections will present live demos of how the library works.
Keep in mind that every table you see is created using **reTables**.

### Brief note about css

The example components in the documentation uses [Tailwind](https://tailwindcss.com/). <br/>
However, nothing prevents you from using the classic css or any other framework.
